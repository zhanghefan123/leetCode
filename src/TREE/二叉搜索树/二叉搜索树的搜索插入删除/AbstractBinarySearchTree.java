package TREE.二叉搜索树.二叉搜索树的搜索插入删除;
...
public class AbstractBinarySearchTree {
    ...
    // 删除的思路
    /*
    * 情况1:若要删除的结点是叶子结点，直接删除即可
    * 情况2:若要删除的结点只有左子树或者只有右子树，直接让左右子树进行替代即可
    * 情况3:若要删除的结点既有左子树又有右子树，那么拿右子树之中最左侧的结点顶上这个结点
    * 如果这个右子树之中最左侧的结点还有右子树，这个右子树托管给这个最左侧结点的父结点
    * ，同理也可以有左子树的最右侧结点顶上去。
    * 搜索二叉树的中序遍历正好是升序的，一个结点我们可以使用这个结点的中序前驱顶上去
    * 也可以使用这个结点的中序前驱后继顶上去。
    * */
